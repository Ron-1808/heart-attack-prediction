...
# ======================================
# ABOUT + MODEL INFO (IMAGE 2 STYLE)
# ======================================
...
with col1:
    ...
    st.info(
        """
        • Uses Machine Learning (KNN)  
        • Trained on real heart disease dataset  
        • Helps identify risk levels early  
